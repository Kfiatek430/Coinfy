<nav class="bg-blue-900 fixed w-full z-20 top-0 start-0">
  <div
  ...
  >
    ...
    >
      <ul
        class="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-white md:bg-blue-900 border-gray-700"
      >
        <li>
          <a
            href="#"
